...
Agradeço também o [Marcos Vinícius da Silva Santos](https://github.com/Marcos-VSS) o Mago supremo da Robótica, ele foi quem abraçou o projeto de corpo e decidiu colaborar comigo para juntos levarmos o IFB as alturas. Ele sempre foi muito dedicado, quando falei sobre o projeto ele quase saltou de felicidade, afinal, assim como eu ele ama essa Instuição. Ele sempre gostou da mecanica dos robôs e hoje ele participa da [DROID](https://www.droidunb.com/). Com muito carinho ele decidiu que iria seguir no Projeto, ensinando robótica para os meninos e focando na [OBR](https://obr.robocup.org.br/). 
